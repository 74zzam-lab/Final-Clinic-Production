...
async function main() {
  ...
  // Pre-login bootstrap (no session) still allowed for cache:writeLicense
  check(rbacSession.assertChannelAllowed({ sender: { id: 999 } }, 'cache:writeLicense').ok, 'no session bootstrap writeLicense ok');
