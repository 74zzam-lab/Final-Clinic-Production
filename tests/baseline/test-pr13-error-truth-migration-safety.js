...
(async () => {
  ...
  check(getSchemaVersion(db) === 7, 'schema v7 after migration 004');
  check(
  ...
  db.prepare(
    `INSERT INTO upgrade_migration_runs (id, source_version, status, started_at) VALUES (?, 'legacy', 'in_progress', ?)`
